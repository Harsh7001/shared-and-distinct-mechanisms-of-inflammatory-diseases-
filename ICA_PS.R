...
a <- fastICA(counts, 2, alg.typ = "parallel", fun = "logcosh", alpha = 1, 
...
plot(1:nrow(counts), counts[, 1], type = "l", main = "Original Signal 1", 
     xlab = "", ylab = "")
plot(1:nrow(counts), counts[, 2], type = "l", main = "Original Signal 2", 
     xlab = "", ylab = "")
...
plot(1:nrow(counts), a$S[, 1], type = "l", main = "ICA Source Estimate 1", 
     xlab = "", ylab = "")
plot(1:nrow(counts), a$S[, 2], type = "l", main = "ICA Source Estimate 2", 
     xlab = "", ylab = "")
